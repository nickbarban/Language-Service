...
ALTER TABLE audio ADD CONSTRAINT audio_audio_genre FOREIGN KEY audio_audio_genre (id_audio_genre)
    REFERENCES audio_genre (id_audio_genre);
-- Reference:  audio_language (table: audio)


ALTER TABLE audio ADD CONSTRAINT audio_language FOREIGN KEY audio_language (id_lang)
    REFERENCES language (id_lang);
-- Reference:  course_language (table: course)


ALTER TABLE course ADD CONSTRAINT course_language FOREIGN KEY course_language (id_lang)
    REFERENCES language (id_lang);
-- Reference:  course_lesson (table: lesson)


ALTER TABLE lesson ADD CONSTRAINT course_lesson FOREIGN KEY course_lesson (id_course)
    REFERENCES course (id_course);
-- Reference:  course_user_course (table: user_course)


ALTER TABLE user_course ADD CONSTRAINT course_user_course FOREIGN KEY course_user_course (id_course)
    REFERENCES course (id_course);
-- Reference:  exercise_type (table: exercise)


ALTER TABLE exercise ADD CONSTRAINT exercise_type FOREIGN KEY exercise_type (id_type)
    REFERENCES exercise_type (id_type);
-- Reference:  language_video (table: video)


ALTER TABLE video ADD CONSTRAINT language_video FOREIGN KEY language_video (id_lang)
    REFERENCES language (id_lang);
-- Reference:  language_word (table: word)


ALTER TABLE word ADD CONSTRAINT language_word FOREIGN KEY language_word (id_lang)
    REFERENCES language (id_lang);
-- Reference:  lesson_lesson (table: lesson)


ALTER TABLE lesson ADD CONSTRAINT lesson_lesson FOREIGN KEY lesson_lesson (id_next)
    REFERENCES lesson (id_lesson);
-- Reference:  text_language (table: text)


ALTER TABLE text ADD CONSTRAINT text_language FOREIGN KEY text_language (id_lang)
    REFERENCES language (id_lang);
-- Reference:  text_text_genre (table: text)


ALTER TABLE text ADD CONSTRAINT text_text_genre FOREIGN KEY text_text_genre (id_text_genre)
    REFERENCES text_genre (id_text_genre);
-- Reference:  user_audio_audio (table: user_audio)


ALTER TABLE user_audio ADD CONSTRAINT user_audio_audio FOREIGN KEY user_audio_audio (id_audio)
    REFERENCES audio (id_audio);
-- Reference:  user_course_user (table: user_course)


ALTER TABLE user_course ADD CONSTRAINT user_course_user FOREIGN KEY user_course_user (id_user)
    REFERENCES user (id);
-- Reference:  user_exercise_exercise (table: user_exercise)


ALTER TABLE user_exercise ADD CONSTRAINT user_exercise_exercise FOREIGN KEY user_exercise_exercise (id_exercise)
    REFERENCES exercise (id_exercise);
-- Reference:  user_exercise_user (table: user_exercise)


ALTER TABLE user_exercise ADD CONSTRAINT user_exercise_user FOREIGN KEY user_exercise_user (id_user)
    REFERENCES user (id);
-- Reference:  user_language (table: user)


ALTER TABLE user ADD CONSTRAINT user_language FOREIGN KEY user_language (id_lang)
    REFERENCES language (id_lang);
-- Reference:  user_text_text (table: user_text)


ALTER TABLE user_text ADD CONSTRAINT user_text_text FOREIGN KEY user_text_text (id_text)
    REFERENCES text (id_text);
-- Reference:  user_text_user (table: user_text)


ALTER TABLE user_text ADD CONSTRAINT user_text_user FOREIGN KEY user_text_user (id_user)
    REFERENCES user (id);
-- Reference:  user_user_audio (table: user_audio)


ALTER TABLE user_audio ADD CONSTRAINT user_user_audio FOREIGN KEY user_user_audio (id_user)
    REFERENCES user (id);
-- Reference:  user_video_user (table: user_video)


ALTER TABLE user_video ADD CONSTRAINT user_video_user FOREIGN KEY user_video_user (id_user)
    REFERENCES user (id);
-- Reference:  user_word_user (table: user_word)


ALTER TABLE user_word ADD CONSTRAINT user_word_user FOREIGN KEY user_word_user (id_user)
    REFERENCES user (id);
-- Reference:  user_word_word (table: user_word)


ALTER TABLE user_word ADD CONSTRAINT user_word_word FOREIGN KEY user_word_word (id_word)
    REFERENCES word (id_word);
-- Reference:  video_genre_video (table: video)


ALTER TABLE video ADD CONSTRAINT video_genre_video FOREIGN KEY video_genre_video (id_video_genre)
    REFERENCES video_genre (id_video_genre);
-- Reference:  video_user_video (table: user_video)


ALTER TABLE user_video ADD CONSTRAINT video_user_video FOREIGN KEY video_user_video (id_video)
